...
from util import data_reader_refvos, data_reader, io
...
def train(max_iter, snapshot, dataset, data_dir, setname, mu, lr, bs, tfmodel_folder,
    ...
    for n_iter in range(last_iter + 1, max_iter):
        for n_batch in range(bs):
            ...
            label_bbox = batch['label_bbox']
            true_bbox = batch['true_bbox']
            ...
            label_bbox_batch[n_batch, ...] = label_bbox
            true_bbox_batch[n_batch, ...] = true_bbox
