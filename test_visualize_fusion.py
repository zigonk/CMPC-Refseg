...
#                 mask = np.array(frame, dtype=np.float32)
                ...
                plt.clf()
                plt.subplot(1, 5, 1, figsize=(5, 3))
                plt.text(0, -100, exp, fontsize=13)
                plt.imshow(frame)
                plt.axis('off')
                plt.subplot(1, 5, 2, figsize=(5, 3))
                plt.imshow(up_c3).set_cmap('jet')
                plt.axis('off')
                plt.subplot(1, 5, 3, figsize=(5, 3))
                plt.imshow(up_c4).set_cmap('jet')
                plt.axis('off')
                plt.subplot(1, 5, 4, figsize=(5, 3))
                plt.imshow(up_c5).set_cmap('jet')
                plt.axis('off')
                plt.subplot(1, 5, 5, figsize=(5, 3))
